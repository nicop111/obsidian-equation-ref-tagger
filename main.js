...
class EquationRefTagger extends obsidian_1.Plugin {
    ...
    async tagEquationsAndReferences() {
        ...
        new obsidian_1.Notice(`Tagged ${equationNumber - 1} equations in active file!`);
        //
        ...
        for (const file of files) {
            ...
            const updatedFileContent = fileContent.replace(new RegExp(`\\[\\[(${activeFile.basename}#\\^\\w+)(?:\\|([^\\]]+))?\\]\\]`, 'g'), (match, refName, description) => {
        ...
        new obsidian_1.Notice(`Found ${globalReferencesNumber} references globally and updated them!`);
    }
}
